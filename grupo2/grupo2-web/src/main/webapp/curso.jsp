		...
		<div class="site-wrapper content">
				...
				<div class="row features-row wow fadeInUp">
					...
					<div class="col-md-4 col-sm-12 feature-column">
						...
						<div class="feature-info">
							...
							<p class="feature-description">Vivamus molestie phasellus
								enim sed orci eu pharetra. Donec posuere nunc vitae tortor
								sagittis feugiat in non massa.</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-12 feature-column">
						<div class="feature-icon">
				...
				<div class="row">
					...
					<div class="col-md-6 text-left about-text">
						...
						<p class="grey wow fadeInUp">Fusce faucibus tincidunt nulla,
							tincidunt sagittis magna venenatis quis. Proin commodo eu ipsum
							eu suscipit. In dapibus arcu sit amet imperdiet posuere. Praesent
						...
						<p class="grey wow fadeInUp">Vivamus a placerat ante. Duis
							...
							tristique. Integer lobortis erat in placerat fermentum. Sed
							luctus varius leo ac posuere. Integer eget est vitae dolor.
							Vivamus a placerat ante. Duis vulputate nibh sit amet augue
							vehicula, mattis viverra purus tristique. Integer lobortis erat
							in placerat fermentum. Sed luctus varius leo ac posuere. Integer
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 skills-row">
						...
						<p class="p-info grey wow fadeInUp">Vivamus a placerat ante.
							...
							tristique. Integer lobortis erat in placerat fermentum. Sed
							luctus varius leo ac posuere. Integer eget est vitae dolor. Duis
							vulputate nibh sit amet augue vehicula, mattis viverra purus
					...
					<div class="col-lg-12 wow fadeInUp" style="z-index: 3">
						<div id="quote-slider" class="owl-carousel">
							...
							<div>
								<blockquote>
									<i class="icon-left ion-quote ion-2x highlight"></i> <span>
										A Perfect Design is made with Passion, Dedication,<br>
							...
							<div class="img">
								...
								<div class="overlay">
									<ul class="expand">
										...
										<li class="cbp-l-caption-desc">by Vossen Design</li>
										<li class="cbp-l-icon"><a
											href="http://vimeo.com/16465813" class="cbp-lightbox"
											data-title="Dashboard<br>by Wunderwelt"><i
												class="icon-magnifier"></i></a></li>
				...
				<div class="row">
					...
					<div class="col-md-12 text-center">
						...
						<p class="wow fadeInUp">
							Vivamus a placerat ante. Duis vulputate nibh sit amet augue
							vehicula, mattis ni<br>viverra purus tristique. Proin
							commodo eu ipsum.
						</p>
					...
					<div class="col-md-3 col-sm-6 featured price-list-box">
						<div class="price-box">
							<div class="price-table">
								...
								<p class="price grey">
									<sup class="currency">$</sup> <span class="pricing">199</span>
					...
					<div class="col-md-3 col-sm-6 price-list-box">
						<div class="price-box">
							<div class="price-table">
								...
								<p class="price grey">
									<sup class="currency">$</sup> <span class="pricing">125</span>
									<span class="time-period">Per Month</span>
								</p>
								<p class="features grey">
									<span class="feature">24/7 Free Support</span> <span
					...
					<div class="col-md-3 col-sm-6 price-list-box">
						<div class="price-box">
							<div class="price-table">
								...
								<p class="price grey">
									<sup class="currency">$</sup> <span class="pricing">150</span>
									<span class="time-period">Per Month</span>
								</p>
								<p class="features grey">
									<span class="feature">24/7 Free Support</span> <span
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 text-center">
						<h3 class="section-title white wow fadeInUp">What clients
							say.</h3>
						<p class="subheading grey wow fadeInUp">
						...
						<div id="owl-testimonials" class="owl-carousel">
							...
							<div>
								<div class="testimonial">
									<i class="icon-left ion-quote ion-2x highlight"></i> <span>
										This guys are amazing! They were so quick to respond and let
										me tell you... they are all knowing!<br>I highly
										recommend their themes! They are all about making their
										clients happy.
									</span> <i class="icon-right ion-quote ion-2x highlight"></i>
								</div>
					...
					<div class="col-md-3 col-sm-6 col-footer">
						<div class="contact">
							...
							<ul class="contact-details">
								...
								<li><p>
										<i class="icon ion-ios-telephone highlight"></i> (123)
										456-7891
									</p></li>
								<li><p>
