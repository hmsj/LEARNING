...
<body>
	...
	<div class="site-wrapper content">
		...
		<div class="container">
			...
			<div class="col-md-12 text-center">
				...
				<p class="subheading wow fadeInUp">
					<span class="highlight">${sessionScope.leccion.titulo }</span>
				</p>
			</div>
		...
		<div class="container">
			<div class="col-md-12 text-center">
				<h3 class="section-title white wow fadeInUp">Material de la leccion</h3>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<h3 class="col-md-12 text-center">AÑADE UN ARCHIVO A LA LECCION</h3>
			</div>
			...
			<div class="col-md-6 col-md-offset-3 text-center wow fadeInUp">
				...
				<form method="post" action="nuevoArchivo" name="archivoForm"
					id="archivoForm">

					<fieldset>
						<input name="tituloArchivo" type="text" id="tituloArchivo"
							placeholder="Titulo del archivo*" />
						<label for="file">Documento asociado*</label>
						<input type="file" name="file" id="file" size="60" placeholder="seleccione el archivo que desea subir"/>
       
					</fieldset>
					<input type="submit" class="submit" id="submit"
						value="AÑADIR DOCUMENTO" />
				</form>
			</div>
