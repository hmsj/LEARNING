...
import es.uc3m.tiw.daos.AlumnoLeccionDao;
import es.uc3m.tiw.daos.AlumnoLeccionDaoImpl;
import es.uc3m.tiw.daos.BancoDao;
...
import es.uc3m.tiw.daos.ListaDeseosDao;
import es.uc3m.tiw.daos.ListaDeseosDaoImpl;
import es.uc3m.tiw.daos.LogroDao;
...
public class InicioServlet extends HttpServlet {
	...
	private List<Categoria> listadoCategorias = new ArrayList<Categoria>();
	...
	public void init() throws ServletException {
		...
		try {
			listadoCursos = cursoDao.findAll();
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		...
		try {
			listadoCategorias = categoriaDao.findAll();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		List<ProfesorCurso> listadoProfesoresTitulares = null;
		try {
			listadoProfesoresTitulares = profesorCursoDao.listadoProfesTitulares();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		request.setAttribute("listadoCategorias", listadoCategorias);
		request.setAttribute("listadoCursos", listadoCursos);
		request.setAttribute("listadoProfesoresTitulares", listadoProfesoresTitulares);
		String forwardJSP = "/principal.jsp";//"/principal.jsp";
